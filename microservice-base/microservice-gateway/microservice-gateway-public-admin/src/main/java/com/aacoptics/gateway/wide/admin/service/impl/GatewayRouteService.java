package com.aacoptics.gateway.wide.admin.service.impl;

import com.aacoptics.gateway.wide.admin.config.BusConfig;
...
import com.aacoptics.gateway.wide.admin.events.EventSender;
import com.aacoptics.gateway.wide.admin.mapper.GatewayRouteMapper;
import com.aacoptics.gateway.wide.admin.service.IGatewayRouteService;
...
public class GatewayRouteService extends ServiceImpl<GatewayRouteMapper, GatewayRoute> implements IGatewayRouteService {
    ...
    private static final String GATEWAY_ROUTES = "gateway_routes_public::";
