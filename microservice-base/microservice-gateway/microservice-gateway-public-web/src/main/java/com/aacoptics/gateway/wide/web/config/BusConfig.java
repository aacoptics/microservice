package com.aacoptics.gateway.wide.web.config;

import com.aacoptics.gateway.wide.web.events.BusReceiver;
...
public class BusConfig {
    ...
    private static final String ROUTING_KEY = "gateway-route-public";
