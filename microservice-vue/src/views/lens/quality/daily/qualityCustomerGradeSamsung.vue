  ...
  <div>
    <div class="aac-container">
      <div class="toolbar w-full" style="float:left;padding-top:10px;padding-left:15px;">
        ...
        <el-form :inline="true" :size="size">
          <el-form-item>
            <el-button :loading="exportLoading" type="primary" @click="exportExcelData('三星质量客户评级模板')">导出模板
              <template #icon>
          ...
          <el-row align="middle" class="float-right" justify="center">
            ...
            <el-form-item>
              <el-button :loading="exportReportLoading" type="success" @click="exportReportExcelData('三星客户评级报表')">导出报表
                <template #icon>
                  <font-awesome-icon :icon="['fas', 'download']"/>
                </template>
              </el-button>
...
import {
  ...
  uploadExcel
} from "@/api/lens/quality/qualityCustomerGradeSamsung";
import {ElMessageBox} from "element-plus";

export default {
  name: "qualityCustomerGradeSamsung",
  components: {SysTable},
  data() {
    return {
      size: "default",
