      ...
      <div class="toolbar w-full" style="float:left;padding-top:10px;padding-left:15px;">
        ...
        <el-form :inline="true" :label-width="100" :size="size">
          ...
          <el-row align="middle" class="float-right" justify="center">
            ...
            <el-form-item>
              <el-button :loading="exportReportLoading" type="success" @click="exportReportExcelData('良率问题报表')">导出报表
                <template #icon>
                  <font-awesome-icon :icon="['fas', 'download']"/>
                </template>
              </el-button>
...
import {
  ...
  listExportExcel,
  uploadExcel
} from "@/api/wlg/quality/qualityAppearanceYieldProblem";
import {listAllUser} from "@/api/lens/quality/qualityMil";
import {ElMessageBox} from "element-plus";

export default {
  name: "wlgQualityAppearanceYieldProblem",
  components: {SysTable},
  data() {
    return {
      size: "default",
