  ...
  data() {
    ...
    return {
      ...
      columns: [
        ...
        {prop: "cycleNo", label: "模次号", minWidth: 80, fixed: "left"},
        {prop: "waferId", label: "log file编号", minWidth: 80, fixed: "left"},
        ...
        {sortable: false, prop: "vcode", label: "V编号", minWidth: 80},
        {sortable: false, prop: "vvalue", label: "V数值", minWidth: 80},
        {sortable: false, prop: "vangle", label: "V角度", minWidth: 80},
        {sortable: false, prop: "wcode", label: "W编号", minWidth: 80},
        {sortable: false, prop: "wvalue", label: "W数值", minWidth: 80},
        {sortable: false, prop: "wangle", label: "W角度", minWidth: 80},
