  ...
  <div>
    <div class="aac-container">
      ...
      <el-table :data="tableData" border style="width: 100%" :size="size">
        ...
        <el-table-column prop="modelName" label="模具" width="80" />
        <el-table-column prop="cycleName" label="周期" width="80" />
        <el-table-column prop="periodName" label="阶段" width="80" />
        <el-table-column prop="startTime" label="开始时间" width="120" :formatter="this.dateTimeFormat"/>
        <el-table-column prop="endTime" label="结束时间" width="120" :formatter="this.dateTimeFormat"/>
        <el-table-column prop="avgCycle" label="平均周期" width="100" />
        <el-table-column prop="inputQty" label="投入数" width="80" />
        <el-table-column prop="startWaferId" label="起始模次号" width="100" />
        <el-table-column prop="endWaferId" label="截止模次号" width="100" />

        <el-table-column prop="brokenOk" label="碎裂可流转">
...
export default {
  ...
  methods: {
    dateTimeFormat: function (row, column) {
      ...
      return this.$moment(row[column.property]).format("YY/MM/DD HH:mm");
    },
    edit(row, index) {
      row.iseditor = true;
    },
