          ...
          <el-row>
            <el-col :span="20">
              <el-form-item label="用户" prop="userCode">
                <el-input v-model="dataForm.userCode" auto-complete="off" clearable></el-input>
              </el-form-item>
            </el-col>
          </el-row>
        </el-form>
...
export default {
  ...
  data() {
    return {
      ...
      columns: [
        ...
        {prop: "userCode", label: "用户", minWidth: 100},
  ...
  methods: {
    ...
    findPage: function (data) {
      ...
      findProductLinePermissionPage(this.pageRequest)
          .then((res) => {
    ...
    handleDelete: function (data) {
      if (data.params.length > 0)
        deleteProductLinePermission(data.params[0]).then(data.callback);
    },
    // 显示新增界面
    handleAdd: function () {
