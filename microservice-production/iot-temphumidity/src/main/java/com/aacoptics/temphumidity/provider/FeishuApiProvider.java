...
import com.aacoptics.temphumidity.config.FeishuAppKeyConfig;
...
@Component
@FeignClient(name = "feishu-server", url = "https://open.feishu.cn/open-apis", fallbackFactory = com.aacoptics.temphumidity.provider.FeishuApiProviderFallback.class)
