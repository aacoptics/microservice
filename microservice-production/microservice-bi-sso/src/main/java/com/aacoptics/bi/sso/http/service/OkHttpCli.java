package com.aacoptics.bi.sso.http.service;
...
public class OkHttpCli {
     ...
     * @return string
     */
    public String doPost(String url, Map<String, String> params, Map<String, String> headerParams) {
        FormBody.Builder builder = new FormBody.Builder();
        ...
        if(headerParams != null && headerParams.keySet().size() > 0)
        {
     ...
     * @return M
     */
    public String doPostJson(String url, JSONObject jsonObject, Map<String, String> headerParams) {
        try {
            RequestBody requestBody = RequestBody.create(new ObjectMapper().writeValueAsString(jsonObject), JSON);
