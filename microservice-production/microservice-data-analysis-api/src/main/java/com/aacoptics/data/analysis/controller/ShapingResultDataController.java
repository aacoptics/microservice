        ...
        try {
            ...
            if (datas != null && datas.size() > 0) {
                for (int i = 0; i < datas.size(); i++) {
                    ...
                    row.createCell(15).setCellValue(p.getKanheRoundness());
                    row.createCell(16).setCellValue(p.getOuterDiameterAverage());
                    row.createCell(17).setCellValue(p.getOuterDiameterRange());
                    row.createCell(18).setCellValue(p.getOuterDiameterRoundness());
                    row.createCell(19).setCellValue(p.getOuterDiameterShrinkage());
                    row.createCell(20).setCellValue(p.getOuterDiameterRoughness());
                    row.createCell(21).setCellValue(p.getR1Flatness());
                    row.createCell(22).setCellValue(p.getR2Flatness());
                    row.createCell(23).setCellValue(p.getR1SplitAverage());
                    row.createCell(24).setCellValue(p.getR2SplitAverage());
                    row.createCell(25).setCellValue(p.getWftStability());
                    row.createCell(26).setCellValue(p.getWftConsistency());
                    row.createCell(27).setCellValue(p.getWftMaxAs());
                    row.createCell(28).setCellValue(p.getWftOuterDiameterShrinkage());
                    row.createCell(29).setCellValue(p.getCftR1());
                    row.createCell(30).setCellValue(p.getCftR2());
                    row.createCell(31).setCellValue(p.getCftConsistency());
                    row.createCell(32).setCellValue(p.getCftMaxAs());
                    row.createCell(33).setCellValue(p.getCoatingTrend());
                    row.createCell(34).setCellValue(p.getCfsrR1());
                    row.createCell(35).setCellValue(p.getCfsrR2());
                    row.createCell(36).setCellValue(p.getCfsrR1R2());
                    row.createCell(37).setCellValue(p.getBurr());
                    row.createCell(38).setCellValue(p.getWeldline());
                    row.createCell(39).setCellValue(p.getAppearanceProblem());
                    row.createCell(40).setCellValue(p.getAppearanceImg());
                    row.createCell(41).setCellValue(p.getRemarks());
                }
            }
