...
public class ShapingResultDataService extends ServiceImpl<ShapingResultDataMapper, ShapingResultData> implements IShapingResultDataService {
    ...
    public void importShapingResultDataExcel(InputStream in) throws Exception {
        ...
        for (int i = 3; i < excelDataList.size(); i++) {
            ...
            String kanheRoundness = dataArray[15];
            String outerDiameterAverage = dataArray[16];
            String outerDiameterRange = dataArray[17];
            String outerDiameterRoundness = dataArray[18];
            String outerDiameterShrinkage = dataArray[19];
            String outerDiameterRoughness = dataArray[20];
            String r1Flatness = dataArray[21];
            String r2Flatness = dataArray[22];
            String r1SplitAverage = dataArray[23];
            String r2SplitAverage = dataArray[24];
            String wftStability = dataArray[25];
            String wftConsistency = dataArray[26];
            String wftMaxAs = dataArray[27];
            String wftOuterDiameterShrinkage = dataArray[28];
            String cftR1 = dataArray[29];
            String cftR2 = dataArray[30];
            String cftConsistency = dataArray[31];
            String cftMaxAs = dataArray[32];
            String coatingTrend = dataArray[33];
            String cfsrR1 = dataArray[34];
            String cfsrR2 = dataArray[35];
            String cfsrR1R2 = dataArray[36];
            String burr = dataArray[37];
            String weldline = dataArray[38];
            String appearanceProblem = dataArray[39];
            String appearanceImg = dataArray[40];
            String remarks = dataArray[41];
            ...
            shapingResultData.setKanheRoundness(kanheRoundness);
            ...
            shapingResultData.setWftOuterDiameterShrinkage(wftOuterDiameterShrinkage);
