        ...
        try {
            ...
            if (datas != null && datas.size() > 0) {
                for (int i = 0; i < datas.size(); i++) {
                    ...
                    row.createCell(6).setCellValue(p.getStructureSchemesNo());
                    row.createCell(7).setCellValue(p.getCoreThicknessLens());
                    row.createCell(8).setCellValue(p.getMaxWallThickness());
                    row.createCell(9).setCellValue(p.getMinWallThickness());
                    row.createCell(10).setCellValue(p.getMaxCoreRatio());
                    row.createCell(11).setCellValue(p.getMaxMinRatio());
                    row.createCell(12).setCellValue(p.getOpticsMaxAngleR1());
                    row.createCell(13).setCellValue(p.getOpticsMaxAngleR2());
                    row.createCell(14).setCellValue(p.getOuterDiameter());
                    row.createCell(15).setCellValue(p.getEdgeThickness());
                    row.createCell(16).setCellValue(p.getWholeMinWallThickness());
                    row.createCell(17).setCellValue(p.getWholeMaxWallThickness());
                    row.createCell(18).setCellValue(p.getWholeMaxMinRatio());
                    row.createCell(19).setCellValue(p.getWholeDiameterThicknessRatio());
                    row.createCell(20).setCellValue(p.getMaxAngleR1());
                    row.createCell(21).setCellValue(p.getMaxAngleR2());
                    row.createCell(22).setCellValue(p.getR1MaxHeightDifference());
                    row.createCell(23).setCellValue(p.getR2MaxHeightDifference());
                    row.createCell(24).setCellValue(p.getR1R2Distance());
                    row.createCell(25).setCellValue(p.getMiddlePartThickness());
                    row.createCell(26).setCellValue(p.getBottomDiameterDistance());
                    row.createCell(27).setCellValue(p.getMechanismDiameterThicknessRatio());
                    row.createCell(28).setCellValue(p.getR1KanheAngle());
                    row.createCell(29).setCellValue(p.getR1KanheHeight());
                    row.createCell(30).setCellValue(p.getR2KanheAngle());
                    row.createCell(31).setCellValue(p.getR2KanheHeight());
                    row.createCell(32).setCellValue(p.getR1Srtm());
                    row.createCell(33).setCellValue(p.getR2Srtm());
                    row.createCell(34).setCellValue(p.getR1SplitPosition());
                    row.createCell(35).setCellValue(p.getR2SplitPosition());
                    row.createCell(36).setCellValue(p.getOuterDiameterSrtm());
                    row.createCell(37).setCellValue(p.getPartSurfaceLiftRatio());
                    row.createCell(38).setCellValue(p.getMechanismTrou());
                    if (StringUtils.isEmpty(p.getAssemblyDrawing())) {
                        row.createCell(39).setCellValue("");
                    } else {
                        row.createCell(39).setCellValue(picPath + p.getAssemblyDrawing().substring(0, p.getAssemblyDrawing().indexOf(".")));
                    }
                }
            }
