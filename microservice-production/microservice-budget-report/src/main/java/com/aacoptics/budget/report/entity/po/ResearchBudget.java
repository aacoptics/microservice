...
@NoArgsConstructor
@AllArgsConstructor
@TableName("fb_research_budget")
public class ResearchBudget extends BasePo {
     ...
     * 季度-q1
     */
    @TableField(value = "q1_value")
    private BigDecimal q1Value;

    /**
     * 季度-02
     */
    @TableField(value = "q2_value")
    private BigDecimal q2Value;

    /**
     * 季度-03
     */
    @TableField(value = "q3_value")
    private BigDecimal q3Value;

    /**
     * 季度-04
     */
    @TableField(value = "q4_value")
