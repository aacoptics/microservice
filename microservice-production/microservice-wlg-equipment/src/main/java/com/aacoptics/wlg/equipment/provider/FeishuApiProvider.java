...
@Component
@FeignClient(name = "feishu-server", url = "https://open.feishu.cn/open-apis", fallbackFactory = com.aacoptics.wlg.equipment.provider.FeishuApiProviderFallback.class)
